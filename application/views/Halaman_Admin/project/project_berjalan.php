    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="#">UMKM</a></li>
          <li class="active">Data UMKM Berjalan</li>
        </ol>
      </section>
                        ...
                        <tbody>
                          ...
                          foreach ($data_project as $project) { ?>
                            <tr>
                               ...
                               <td style="vertical-align: middle; text-align: center;">
                                <a href="<?= site_url('Halaman_Admin/Project/detailProjectBerjalan/'.$project->id_project) ?>" title="Lihat Detail Data"class="btn btn-success" style="background:#00b3b3"><i class="fa fa-search"></i> Detail</a>
                                <a href="<?= site_url('Halaman_Admin/Project/Request/'.$project->id_project) ?>" title="Lihat Detail Data"class="btn btn-warning" style="background:orange"><i class="fa fa-pencil"></i> Request</a>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
