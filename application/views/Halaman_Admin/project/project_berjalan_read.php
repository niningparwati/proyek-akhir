                    ...
                    <div style="padding: 15px;">
                        <table class="table table-striped pull-left" id="mytable" style="width: 60%">
                            ...
                            <tr>
                                ...
                                <td><button class="btn bg-blue btn-flat margin">Rp <?= number_format($dana_dibutuhkan,2,',','.') ?></button></td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            foreach ($data_donasi as $value) { ?>
                                <tr>
                                    ...
                                    <td style="text-align: left; border:1px solid black; padding-left: 5px">Rp <?= number_format($value->nominal,2,',','.') ?></td>
