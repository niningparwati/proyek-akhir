...
<header class="nav-holder make-sticky">
  <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
    <div class="container"><a href="index.html" class="navbar-brand home"><img src="<?= base_url()?>assets/logo/uproject.png" style="width: 300px; height: 80px;" alt="Universal logo" class="d-none d-md-inline-block"><img src="<?= base_url()?>assets/logo/uproject.png" style="width: 300px; height: 80px;" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
