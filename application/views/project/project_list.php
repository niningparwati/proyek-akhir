                          ...
                          foreach ($data_project as $project) { ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle; text-align: center;">
                                 ...
                                 <td style="vertical-align: middle; text-align: left;"><?= $project->dana_dibutuhkan ?></td>
                                 <td style="vertical-align: middle; text-align: left;"><?= $project->status ?></td>
                                 <td style="vertical-align: middle; text-align: center;">
                                    <a href="<?= site_url('Halaman_Admin/Project/detailProject/'.$project->id_project) ?>" title="Lihat Detail Data"class="btn btn-success"><i class="fa fa-search"></i> Detail</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
