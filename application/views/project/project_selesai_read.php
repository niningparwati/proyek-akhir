  ...
  <div class="wrapper" style="background-color: #000000 ">
    ...
    <div class="content-wrapper">
      ...
      <ol class="breadcrumb">
          ...
          <li class="active">Project Selesai</li>
          <li class="active">Detail Project Selesai</li>
      </ol>
  </section>
            ...
            <div class="box box-success">
                ...
                <div style="padding: 15px;width: 100%">
                    ...
                    <div class="col-md-9 pull-left">
                        <h3 style="font-weight: bold;">Donasi Terkumpul</h3>
                    </div>
                    <div class="col-md-3">
                        <?php if ($donasi_masuk) { ?>
                    ...
                    <br><br><br><br>
                    <a href="<?= site_url('Halaman_Admin/Project/projectSelesai') ?>" class="btn btn-danger">
