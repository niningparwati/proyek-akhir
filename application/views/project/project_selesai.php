    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Data Project Selesai</li>
        </ol>
      </section>
                  ...
                  <tbody>
                    ...
                    foreach ($data_project as $project) { ?>
                      <tr>
                       ...
                       <td style="vertical-align: middle; text-align: center;">
                        <a href="<?= site_url('Halaman_Admin/Project/detailProjectSelesai/'.$project->id_project) ?>" title="Lihat Detail Data"class="btn btn-success" style="background:#00b3b3">Detail</a>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
