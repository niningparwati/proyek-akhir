  ...
  <div class="wrapper" style="background-color: #000000 ">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
            Detail Project Ditolak
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
          <li><a href="#">Project</a></li>
          <li class="active">Project Ditolak</li>
          <li class="active">Detail Project Ditolak</li>
      </ol>
  </section>
        ...
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div style="padding: 15px;width: 100%">
                    <a href="<?= site_url('Halaman_Admin/Project/projectDitolak') ?>" class="btn btn-danger">
