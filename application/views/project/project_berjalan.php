  ...
  <div class="wrapper" style="background-color: #000000 ">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Data Project Berjalan
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
          <li><a href="#">Project</a></li>
          <li class="active">Data Project Berjalan</li>
        </ol>
      </section>
                        ...
                        <tbody>
                          ...
                          foreach ($data_project as $project) { ?>
                            <tr>
                               ...
                               <td style="vertical-align: middle; text-align: center;">
                                <a href="<?= site_url('Halaman_Admin/Project/detailProjectBerjalan/'.$project->id_project) ?>" title="Lihat Detail Data"class="btn btn-success" style="background:#00b3b3">Detail</a>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
