...
class Login extends CI_Controller {
	...
	function index(){ // FIX
        ...
        $data= array(
            'action' => base_url('index.php/Halaman_Admin/Login/aksiLogin'),
            'judul' => 'U-Project',
            'nama_aplikasi' => 'U-PROJECT | Urunan Project',
            'logo' => 'assets/images/uproject.png',
        );
        $this->load->view('Halaman_Admin/admin/login',$data);
    }
    ...
    public function Tambah(){ // FIX
        ...
        $data= array(
            'action' => base_url('index.php/Halaman_Admin/Login/aksiRegis'),
            'judul' => 'U-Project',
            'nama_aplikasi' => 'U-PROJECT | Urunan Project',
            'logo' => 'assets/images/uproject.png',
        ...
        $this->load->view('Halaman_Admin/admin/regis',$data);
    }
    ...
    public function aksiRegis() //FIX
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($cekemail) {
                ...
                redirect(site_url('Halaman_Admin/Login/Tambah'));
            }else{
                ...
                redirect(site_url('Halaman_Admin/Login'));
            }
        }
    }
