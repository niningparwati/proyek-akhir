...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2019 at 03:20 AM
...
('001-DNS-260819110749', '001-USER-12071908433', '001-PRJ-140719113546', 18, '20000000', '2019-08-26', 'Menunggu Konfirmasi', 'chef-156108__34061.png', 'pending');
...
--
-- Table structure for table `kategori_pendanaan`
--
...
--
-- Dumping data for table `kategori_pendanaan`
--
...
('001-PRJ-140719111334', '001-USER-11071907193', 'anggota.png', 'Proyek Akhir', 'dkasjkjdnd jdhfieiiurut kajdlaeoifj fksl;adepkd mnvnkdf alepekdjf jfkslmamck ldfkjf', 100000000, '2019-07-14', '2020-01-14', 'KTP.pdf', 'form_permohonan_kk_baru_WNI.pdf', 'berjalan', 'Lengkap', 'standar', 'Usaha'),
('001-PRJ-140719113546', '001-USER-10071904412', 'kepemimpinan-etis-melakukan-sesuatu-yang-benar2.jpg', 'Project Teman', 'kf kjkdjsk gfhdjh jjksjka jmxnmnx hdhhfks ieouowf kkskmkc', 50000000, '2019-07-14', '2020-01-14', 'pelaporan_mati_WNI.pdf', 'keterangan_kelahiran2.pdf', 'berjalan', 'Lengkap', 'standar', 'Kegiatan'),
('001-PRJ-180719012743', '001-USER-10071904412', 'chef-156108__340.png', 'Project Baru', 'kjkkjbbhb', 55000000, '2019-07-18', '2020-01-18', 'KTP2.pdf', 'form_permohonan_kk_baru_WNI1.pdf', 'pending', 'Lengkap', 'medium', 'Usaha'),
('001-PRJ-180719110427', '001-USER-12071908433', 'the-art-4.png', 'Project Satu', 'jsdkskfdkkfnc mslmxlspeir mkcmkdk maksk huehhri nadnhdjw kamswooej hddirijka jakjdeijd hdskjkdjjf hrysjahsiey jdhud7rhj kalsopehrb hsbwhwkaha lakjsod', 50000000, '2019-07-18', '2020-01-18', 'images.jpg', 'pencatatan_perkawinan.pdf', 'berjalan', 'Lengkap', 'medium', 'Usaha'),
('001-PRJ-180719111048', '001-USER-18071911100', 'questions-1014060_960_720.jpg', 'Jembatan Dua', 'djdaskjdkjkd heiwuewoj hakskakd ndhdjsfkskd hewueyioqon nskakd kalsko heuwehw jkajsiw bheyrutb dbcgdhaj jakqhiwueeydh', 40000000, '2019-07-18', '2020-01-18', 'Being-an-authentic-leader.png', 'permohonan_pindah_antar_desa_dalam_1_kecamatan.pdf', 'berjalan', 'Lengkap', 'standar', 'Kegiatan'),
('001-PRJ-180719123854', '001-USER-11071907193', 'ds.png', 'Project Ketiga', 'shdkakdx, x', 30000000, '2019-07-18', '2020-01-18', 'KTP1.pdf', 'form_permohonan_perubahan_kk_WNI.pdf', 'pending', 'Lengkap', 'medium', 'Usaha'),
('001-PRJ-180719124719', '001-USER-11071907193', 'anggota1.png', 'Project Keempat', 'djsakdkjjoeon x dkasjlda', 35000000, '2019-07-18', '2020-01-18', 'chef-156108__340.png', 'form_permohonan_perubahan_kk_WNI1.pdf', 'berjalan', 'Lengkap', 'standar', 'Kegiatan');
...
--
-- Indexes for table `kategori_pendanaan`
--
